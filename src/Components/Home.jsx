      ...
      <div className="text-white flex justify-around font-medium mx-24 mt-16">
        <div className="text-[#A6A9AA]">
          ...
          <h1 className="mt-4 mx-16">
            ...
            <div className="text-7xl w-56 text-white mx-10 font-Kode">{name}</div><span className="text-sm">&lt;/h1&gt;</span>
          </h1>
          <p className="mt-4">
            <span className="text-sm">&lt;p&gt;</span>{" "}
            <span className="text-[#02F74C] text-sm font-code text-lg font-semibold">{title}</span>
            <span className="text-sm">&lt;/p&gt;</span>{" "}
          </p>
        </div>
        <div className="">
